...
D=$FCST_DIAG_START_TIME
cat <<EOF

"da_daily%4yr%2mo%2dy",     1,"days",  1, "days", "time", 1,"days", "${D:0:4} ${D:4:2} ${D:6:2} ${D:8:2} 0 0", 1, "days"
#"da_hourly%4yr%2mo%2dy",1,"hours", 1, "hours","time", 1,"days", "${D:0:4} ${D:4:2} ${D:6:2} ${D:8:2} 0 0", 1, "days"

'ocean_model_z', 'temp',     'Temp',     'da_daily%4yr%2mo%2dy',    'all', 'mean','none',2
'ocean_model_z', 'salt',     'Salt',     'da_daily%4yr%2mo%2dy',    'all', 'mean','none',2
'ocean_model',   'SSH',      'SSH',      'da_daily%4yr%2mo%2dy',    'all', 'mean','none',2
'ocean_model',   'SST',      'SST',      'da_daily%4yr%2mo%2dy',    'all', 'min', 'none',2

#'ocean_model',   'SST',      'SST',      'da_hourly%4yr%2mo%2dy',   'all', 'none','none',2
#'ocean_model',   'SSH',      'SSH',      'da_hourly%4yr%2mo%2dy',   'all', 'none','none',2

## TODO, U,V aren't needed by the DA right now, but they might be eventually
#'ocean_model_z', 'u',        'u',        'da_daily%4yr%2mo%2dy',   'all', 'mean','none',2
#'ocean_model_z', 'v',        'v',        'da_daily%4yr%2mo%2dy',   'all', 'mean','none',2
